<%@page import="Mypack.CorpokitGetSet"%>
		...
		<div class="left-content">
            ...
            <div class="col-md-12">
						...
						<table border="1" id="displaytable" class="table table-bordered" style="display.none" >
                                          ...
                                          int kitid = CorpokitGetSet.getKit();
                                          Connection conn=DBconnect.getConnect();
                                          %>
                                          <%
                                          try{
                                          
                                          String sql="select * from airquuality where kid = '"+kitid+"' ORDER BY id DESC LIMIT 1";
                                       // Execute the query
				 ...
				 <h2>&nbsp &nbsp View Predicted Air Quality</h2>
				 ...
				 <table border="1" id="displaytable" class="table table-bordered" style="display.none" >
								          ...
								          String sql3="select * from predict_airquuality where kid = '"+kitid+"' ORDER BY id DESC LIMIT 1";
											//Execute the query
				 ...
				 <center>
				 <a href="welcomeCorpo.jsp" >Back</a>
						</center>							      
