	...
	<div class="page-container">
		...
		<div class="left-content">
			<div class="mother-grid-inner">
				...
				<h2>Prediciton Table</h2><br><br>
					<div class="agileits-box">
						
							 <form action="neuralnetworkalgorithm" method="post">
								
							<div class="form-group row">
                			<input type="hidden" name="action" value="add"/>
    						<label for="inputEmail3" class="col-sm-3 form-control-label">Kit-ID</label>
                	  		<div class="col-sm-9">
                    		<input type="text" cols="7" rows="1" class="form-control" name="kitTxt" placeholder="Enter Kit-Id" required></input>
                 			</div>
               			 	</div>
               			 	
               			 	<div class="form-group row">
                			<input type="hidden" name="action" value="add"/>
    						<label for="inputEmail3" class="col-sm-3 form-control-label">Number Of Days</label>
                  			<div class="col-sm-9">
                    		<input type="text" cols="7" rows="1" class="form-control" name="daysTxt" placeholder="Enter Number of Days" onblur="validateEmail(this);" required></input>
                 			</div>
                			</div> 
