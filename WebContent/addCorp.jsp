	...
	<div class="page-container">
		...
		<div class="left-content">
			<div class="mother-grid-inner">
				...
				<h2>Add Municipal Corporation</h2><br><br>
					<div class="agileits-box">
						
							 <form action="AddCorp" method="post">
								
							<div class="form-group row">
                			<input type="hidden" name="action" value="add"/>
    						<label for="inputEmail3" class="col-sm-3 form-control-label">Name</label>
                	  		<div class="col-sm-9">
                    		<input type="text" cols="7" rows="1" class="form-control" name="nameTxt" placeholder="Enter Corporation Name" required></input>
                 			</div>
               			 	</div>
    						...
    						<label for="inputEmail3" class="col-sm-3 form-control-label">Email</label>
                  			<div class="col-sm-9">
                    		<input type="email" cols="7" rows="1" class="form-control" name="emailTxt" placeholder="Enter Corporation Email ID" onblur="validateEmail(this);" required></input>
                 			</div>
                			</div> 
    						...
    						<label for="inputEmail3" class="col-sm-3 form-control-label">City</label>
                	  		<div class="col-sm-9">
                    		<input type="text" cols="7" rows="1" class="form-control" name="cityTxt" placeholder="Enter City Name" required></input>
                 			</div>
               			 	</div><br>
		...
		<div class="menu">
			<ul id="menu">
				...
				<li><a href="viewCorp.jsp"><i class="fa fa-edit"></i>
						...
						<li><a href="viewAdminprediction.jsp"><i class="fa fa-edit"></i>
